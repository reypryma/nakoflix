...
final Content sintelContent = Content(
  ...
  imageUrl: Assets.coverb,
  titleImageUrl: Assets.sintelTitle,
  videoUrl: Assets.sintelVideoUrl,
  description:
      'The 150-year-long stalemate between the two interstellar superpowers, the Galactic Empire and the Free Planets Alliance, comes to an end'
      '\nAs ideologies clash amidst the war'
      's many casualties, the two strategic masterminds must ask themselves what the real reason behind their battle is.',
);
